...
public class GroupUpdateFragment extends Fragment {
    private final static String TAG = "TAG_GroupUpdateFragment";
    ...
    private CommonTask travelDetailGetAllTask, groupGetAllTask, travelTask;
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        if (group != null) {
            ...
            if (Common.networkConnected(activity)){
                ...
                travelTask = new CommonTask(url, jsonOut);
                try {
                    String jsonIn = travelTask.execute().get();
        ...
        travelName = preferences.getString("travelName", DEFAULT_TRAVEL_NAME);
        int travelId = group.getTRAVEL_ID();
        String tName = travel.getTravel_name();
        preferences.edit()

                .putInt("travelid", travelId)
                .putString("travelName", tName)
                .apply();
        ...
        btFinshInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(activity)
                        /* 設定標題 */
                        .setTitle(R.string.textFinishUpdate)
                        /* 設定圖示 */
                        .setIcon(R.drawable.alert)
                        /* 設定訊息文字 */
                        .setMessage(R.string.textGroupUpdateMessage)
                        ...
                        .setPositiveButton(R.string.textYes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (Common.networkConnected(activity)) {
                                    ...
                                    group.setGroup(travelId, name, 1, upper, 2, dateStart, dateEnd, eventDate, 1, notes);
...
//                                    Gson gson = new GsonBuilder().setDateFormat("yyyy/MM/dd").create();
        ...
        btTravelPickr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.groupInsertTravelFragment);
...
//                                calendar.set(year, month, dayOfMonth, 23, 59, 59);
    ...
    private void showGroup() {
        ...
        date1 = group.getGP_EVENTDATE();
        date2 = group.getGP_DATESTAR();
        date3 = group.getGP_DATEEND();
        etName.setText(group.getGP_NAME());
        etNotes.setText(group.getGP_NOTES());
        tvTravelName.append("");
        tvDateTime.append(":" + simpleDateFormat.format(date1));
        tvDateTime2.append(":" + simpleDateFormat.format(date2));
        tvDateTime3.append(":" + simpleDateFormat.format(date3));
        ...
        if(DEFAULT_TRAVEL_NAME != "") {
            ...
            tvTravelName.append(":" + travel.getTravel_name());
        }
