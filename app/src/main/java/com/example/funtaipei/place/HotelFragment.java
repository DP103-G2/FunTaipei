...
public class HotelFragment extends Fragment {
    ...
    private static final String TAG = "TAG_HotelFragment";
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        places = getPlaces();
        showPlaces(places);
        activity.setTitle("飯店");
        Button btView = view.findViewById(R.id.btView);
        btView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_hotelFragment_to_placeListFragment);
        ...
        btResturant.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_hotelFragment_to_restaurantFragment);
            }
        });
    ...
    private List<Place> getPlaces() {
        ...
        if (Common.networkConnected(activity)) {
            ...
            jsonObject.addProperty("action", "getHotel");
    ...
    private void showPlaces(List<Place> places) {
        ...
        HotelAdapter hotelAdapter = (HotelAdapter) rvPlace.getAdapter();

        if (hotelAdapter == null) {
            rvPlace.setAdapter(new HotelFragment.HotelAdapter(activity, places));
        } else {
            hotelAdapter.setPlaces(places);
            hotelAdapter.notifyDataSetChanged();
        }
    }

    public class HotelAdapter extends RecyclerView.Adapter<HotelFragment.HotelAdapter.MyViewHolder> {
        private LayoutInflater layoutInflater;
        private List<Place> places;
        private int imageSize;

        HotelAdapter(Context context, List<Place> places) {
        ...
        @Override
        public void onBindViewHolder(@NonNull HotelFragment.HotelAdapter.MyViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Navigation.findNavController(view).navigate(R.id.action_hotelFragment_to_placeDetailsFragment, bundle);
                }
            });
                                ...
                                case R.id.delete:
                                    if (Common.networkConnected(activity)) {
                                        ...
                                        if (count == 0) {
                                            ...
                                            places.remove(place);
                                            HotelFragment.HotelAdapter.this.notifyDataSetChanged();
                                            // 外面spots也必須移除選取的spot
                                            HotelFragment.this.places.remove(place);
